...
?>
  ...
  <div class="container">
        ...
        <div class="carousel-inner">
          ...
          <div class="item active">
            <div class="carousel-caption d-none d-md-block w-50 ml-auto mr-auto">
              <h1 class="bheader">BELTS</h1>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis
                ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas
                accumsan lacus vel facilisis.</p>
            </div>
            <img src="img/banner9.png" class="img-responsive">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 text-center">
            <a class="link" href="#">
              <img src="img/beltmen.png" class="center">
            </a>
            <h4 class="header">KOOL-KGL5</h4>
          </div>
          <div class="col-lg-6 text-center">
            <a class="link" href="#">
            <img src="img/beltswomen.png" class="center">
          </a>
    ...
    $query = "SELECT `id`,`name`, `code`, `price`, `image` FROM `products` WHERE category='Belts' ORDER BY RAND() LIMIT 3";
      ...
      <div id="back2">
        <div class="container">
          ...
          <div id="arrival" class="row">
            ...
            <?php
            $query = "SELECT `id`,`name`, `code`, `price`, `image` FROM `products` WHERE category='Belts' AND gender='M'";
            $result = mysqli_query($con, $query);
            ?>
          ...
          <?php
          $query = "SELECT `id`,`name`, `code`, `price`, `image` FROM `products` WHERE category='Belts' AND gender='W'";
          $result = mysqli_query($con, $query);
          ?>
