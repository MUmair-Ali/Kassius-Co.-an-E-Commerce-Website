  ...
  <div class="container">
    ...
    $query = "SELECT `id`,`name`, `code`, `price`, `image` FROM `products` WHERE category='Shoes' ORDER BY RAND() LIMIT 3";
      ...
      <div id="back2">
        <div class="container">
          ...
          <div id="arrival" class="row">
            ...
            <?php
            $query = "SELECT `id`,`name`, `code`, `price`, `image` FROM `products` WHERE category='Shoes' AND gender='M'";
            $result = mysqli_query($con, $query);
            ?>
          ...
          <?php
          $query = "SELECT `id`,`name`, `code`, `price`, `image` FROM `products` WHERE category='Shoes' AND gender='W'";
          $result = mysqli_query($con, $query);
          ?>
