...
?>
  ...
  <div class="container">
        ...
        <div class="carousel-inner">
          ...
          <div class="item active">
            <div class="carousel-caption d-none d-md-block w-50 ml-auto mr-auto">
              <h1 class="bheader">ACTIVE WEAR</h1>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis
                ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas
                accumsan lacus vel facilisis.</p>
            </div>
            <img src="img/banner4.png" class="img-responsive">
          </div>
        </div>
    </div>
  </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 text-center">
            <a class="link" href="#">
              <img src="img/awmen.png" class="center">
            </a>
            <h4 class="header">ACT-KA23</h4>
          </div>
          <div class="col-lg-6 text-center">
            <a class="link" href="#">
            <img src="img/awwomen.png" class="center">
          </a>
            <h4 class="header">VELVET-KV908</h4>
          </div>
        </div>
      </div>
    </div>
    ...
    $query = "SELECT `id`,`name`, `code`, `price`, `image` FROM `products` WHERE category='Activewear' ORDER BY RAND() LIMIT 3";
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 text-center">
              <h3 class="header">ACTIVE WEAR</h3>
            </div>
          </div>
          <div id="arrival" class="row">
            ...
            <?php
            $query = "SELECT `id`,`name`, `code`, `price`, `image` FROM `products` WHERE category='Activewear' AND gender='M'";
            $result = mysqli_query($con, $query);
            ?>
          ...
          <?php
          $query = "SELECT `id`,`name`, `code`, `price`, `image` FROM `products` WHERE category='Activewear' AND gender='W'";
          $result = mysqli_query($con, $query);
          ?>
