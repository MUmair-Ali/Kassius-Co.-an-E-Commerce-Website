        ...
        <div class="carousel-inner">
          ...
          <div class="item active">
            <div class="carousel-caption d-none d-md-block w-50 ml-auto mr-auto">
              <h1 class="bheader">NEW ARRIVALS</h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 text-center">
            ...
            <h4 class="header">MEN</h4>
          </div>
          <div class="col-lg-6 text-center">
            <a class="link" href="#">
            <img src="img/skirt.png" class="center">
          </a>
            <h4 class="header">WOMEN</h4>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 text-center">
              <h3 class="header">NEW ARRIVALS</h3>
            </div>
          </div>
          ...
          <?php
          $query="SELECT `id`, `name`, `code`, `price`, `image` FROM `products` WHERE category='Novelties' AND gender='M'";
          $result=mysqli_query($con, $query);
          ?>
          ...
          <?php
          $query="SELECT `id`,`name`, `code`, `price`, `image` FROM `products` WHERE category='Novelties' AND gender='W'";
          $result=mysqli_query($con, $query);
          ?>
          ...
          <?php
          $query="SELECT `id`,`name`, `code`, `price`, `image` FROM `products` WHERE category='Belts' OR category='Shades'";
          $result=mysqli_query($con, $query);
          ?>

          <div class="row">
            <div class="col-lg-12">
              <h5 class="header">ACCESSORIES</h5>
              <hr style="height:2px;border-width:0;color:gray;background-color: #b9bcc4">
            </div>
          </div>
          <div class="row">
